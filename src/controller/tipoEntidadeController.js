...
export const add = async (req, res) => {
    ...
    return handleResponse(req, res, 200, { id: create });
};

export const updateTipoEntidade = async (req, res) => {
    // #swagger.tags = ['Tipo_Cliente']
...
export const deleteTipoEntidade = async (req, res) => {
    // #swagger.tags = ['Despesa']
